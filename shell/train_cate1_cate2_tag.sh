...
-test_a_tfrecord_data_path /data/pcg_ceph/ccks/tfrecord/clip_vgg_fea_extractor/vgg_clip_tfrecord/test_a_set \
...
-predict_cate_output /data/pcg_ceph/ccks/my_baseline_clip/predict_out/testset_predict_cate_infos.txt \
-predict_tag_output  /data/pcg_ceph/ccks/my_baseline_clip/predict_out/testset_predict_tag_infos.txt |tee  /data/pcg_ceph/ccks/my_baseline_clip/log/train_tag_1134_cate1_cate2_base.log
